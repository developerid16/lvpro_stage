...
@section('title') Participating Merchant Trash @endsection
...
@component('components.breadcrumb')
    ...
    @slot('title') Participating Merchant Trash @endslot
@endcomponent
...
<div class="card">
    ...
    <div class="card-header bg-white d-flex justify-content-between align-items-center border-bottom mb-3">
        ...
        <!-- Back Button -->
        <a class="btn btn-success" href="{{ url('admin/participating-merchant') }}">

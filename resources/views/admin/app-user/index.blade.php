    ...
    <!-- <div class="wmd-view-topscroll">
        ...
        <div class="table-responsive">
            <table class="sh_table table table-bordered" id="bstable" data-toggle="table"
                ...
                data-filter-control="true" data-show-columns-toggle-all="false" data-search-time-out="100"  data-search-on-enter-key="true">
                <thead>
                    <tr>
                        ...
                        <th data-field="user_type" data-filter-control="select" data-sortable="true">Customer Type</th>
                        <th data-field="unique_id" data-filter-control="input" data-sortable="true">APHID 
                        </th>
                        ...
                        <th data-field="expiry_date" data-sortable="false">APH expiry date</th>

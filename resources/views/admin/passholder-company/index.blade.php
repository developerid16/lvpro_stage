...
@section('title') Passholder Company @endsection
@section('content')
            ...
            <table class="sh_table table table-bordered" id="bstable" data-toggle="table"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="code" data-filter-control="select" data-sortable="true">Category</th>
...
<!-- Create -->
@can("$permission_prefix-create")
@include('admin.passholder-company.add-edit-modal')
@endcan
<!-- end modal -->
@endsection

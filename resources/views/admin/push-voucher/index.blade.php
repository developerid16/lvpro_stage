...
@section('title') Push Voucher @endsection
@section('content')

@component('components.breadcrumb')
@slot('li_1') Admin @endslot
@slot('li_1_link') {{url('/')}} @endslot
@slot('title') Push Voucher Log @endslot
@endcomponent
    ...
    <div class="card-body pt-0">
        <div class="table-responsive">
            <table class="table table-bordered" id="bstable" data-toggle="table"
                ...
                <thead>
                    <tr>
                        <th data-field="sr_no" data-filter-control="input" data-sortable="false" 
                            data-width="75" data-width-unit="px" data-searchable="false">
                            Sr. No.
                        </th>

                        <th data-field="type" data-filter-control="input" data-sortable="true">
                            Type
                        </th>

                        <th data-field="reward_name" data-filter-control="input" data-sortable="true">
                            Reward Name
                        </th>
                        ...
                        <th data-field="created_at" data-filter-control="input" data-sortable="true">
                            Created Date & Time
                        </th>
                    </tr>
                </thead>

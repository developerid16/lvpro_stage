...
@section('title') Club Location Trash @endsection
...
@component('components.breadcrumb')
    ...
    @slot('title') Club Location Trash @endslot
@endcomponent
...
<div class="card">
    ...
    <div class="card-header bg-white d-flex justify-content-between align-items-center border-bottom mb-3">
        ...
        <!-- Back Button -->
        <a class="btn btn-success" href="{{ url('admin/club-location') }}">
            ...
            <table class="table table-bordered" id="bstable"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="deleted_at">Deleted At</th>

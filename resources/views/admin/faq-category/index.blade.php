...
@section('title') FAQ Category @endsection
@section('content')

@component('components.breadcrumb')
@slot('li_1') Admin @endslot
@slot('li_1_link') {{url('/')}} @endslot
@slot('title') FAQ Category @endslot
@endcomponent
            ...
            <table class="sh_table table table-bordered" id="bstable" data-toggle="table"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="category_order" data-filter-control="input" data-sortable="true">Order</th>
                        <th data-field="is_for" data-filter-control="select" data-sortable="true">For</th>
...
<!-- Create -->
@can("$permission_prefix-create")
@include('admin.faq-category.add-edit-modal')
@endcan
<!-- end modal -->
@endsection

...
@section('title') POS Rewards Management @endsection
@section('content')
...
@slot('li_1_link') {{url('/')}} @endslot
@slot('title') Rewards Management POS @endslot
@endcomponent
...
<div class="card">
    {{--<div class="card-header bg-white d-flex justify-content-between align-items-center border-bottom mb-3">
        <h4 class="card-title mb-0">POS Rewards Redemption Management </h4>
...
@section('script')
<script>
    var ModuleBaseUrl = "{{ url('admin/reward-redemption-pos/datatable') }}";
    var DataTableUrl = ModuleBaseUrl;
var statusDefault = {
Purchased: 'Issued',
Redeemed: 'Redeemed',
Expired: 'Expired',

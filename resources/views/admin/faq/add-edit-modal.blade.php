                ...
                <form class="z-index-1" method="POST" action="javascript:void(0)" id="{{ (isset($data->id)) ? 'edit_frm' : 'add_frm' }}" data-id="{{ $data->id ?? ''}}">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="mb-3">
                                <label class="sh_dec" for="question">Question<span class="required-hash">*</span></label>
                                <input id="question" type="text" class="sh_dec form-control" name="question" placeholder="Enter question" value="{{ $data->question ?? '' }}">
                            </div>
                        </div>
                        <div class="col-12 col-md-12">
                            <div class="mb-3">
                                <label class="sh_dec " for="answer">Answers<span class="required-hash">*</span></label>
                                <textarea name="answer" class="elm1" cols="20" rows="10">{{ $data->answer ?? '' }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-check me-2 ">
                                        <input class="form-check-input" value="Chat Bot" type="radio" name="is_for"
                                            id="Chat Bot" @checked(isset($data->is_for) && $data->is_for == 'Chat Bot')>
                                        <label class="form-check-label sh_dec" for="Chat Bot">
                                            Chat Bot
                                        </label>
                                    </div>
                                    <div class="form-check me-2">
                                        <input class="form-check-input" value="FAQ" type="radio" name="is_for" id="FAQ"
                                            @checked(isset($data->is_for) && $data->is_for == 'FAQ')>
                                        <label class="sh_dec form-check-label" for="FAQ">
                                            FAQ
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" value="Both" type="radio" name="is_for"
                                            id="Both" @checked(isset($data->is_for) && $data->is_for == 'Both')>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="sh_dec form-select select2" name="status" id="status">

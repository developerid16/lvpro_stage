            ...
            <div class="modal-body">
                <form class="z-index-1" method="POST" action="javascript:void(0)" id="{{ (isset($data->id)) ? 'edit_frm' : 'add_frm' }}" data-id="{{ $data->id ?? ''}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="sh_dec" for="permission">Select Permission <span class="required-hash">*</span></label>
                                <select class="sh_dec form-select select-multiple " name="permission[]" multiple id="permission" placeholder="Select Permission">

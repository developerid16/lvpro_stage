...
@slot('title') Home Banner Management @endslot
@endcomponent
            ...
            <table class="table table-bordered" id="bstable" data-toggle="table"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="image" data-filter-control="input" data-sortable="true">Image</th>
...
<!-- Create -->
@can("$permission_prefix-create")
@include('admin.home-banner.add-edit-modal')
@endcan
<!-- end modal -->
@endsection

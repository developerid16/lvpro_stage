...
class AboutAppSliderController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        $query = $this->get_sort_offset_limit_query($request, $query, ['url', 'image', 'status']);
        ...
        foreach ($query['data']->get() as $key => $row) {
            ...
            = "<a href='" . asset("images/$row->image") . "' data-lightbox='set-$row->id'> <img src='" . asset("images/$row->image") . "' class='avatar-sm me-3 mx-lg-auto mb-3 mt-1 float-start float-lg-none rounded-circle' data-lightbox='lightbox' alt='img'></a>";

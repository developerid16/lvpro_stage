...
class AnnouncementController extends Controller
{
    function __construct()
    {
        ...
        $this->middleware("active.permission:$permission_prefix-list|$permission_prefix-create|$permission_prefix-edit|$permission_prefix-delete", ['only' => ['index', 'store','datatable']]);

...
class BirthdayVoucherApprovalController extends Controller
{
    function __construct()
    {
        ...
        $this->view_file_path = "admin.birthday-voucher-approval.";
        $permission_prefix = $this->permission_prefix = 'birthday-voucher-approval';
        $this->layout_data = [
            'permission_prefix' => $permission_prefix,
            'title' => 'Birthday Voucher Approval',
            'module_base_url' => url('admin/birthday-voucher-approval')
        ];
    ...
    public function datatable(Request $request)
    {
        ...
        $query = RewardUpdateRequest::with('requester')->where('type','2')->orderBy('created_at', 'desc');

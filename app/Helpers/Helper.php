...
if (!function_exists('getRedirectUrl')) {
    function getRedirectUrl($user)
    {
        $map = [
            ...
            'evoucher-list' => '/admin/evoucher',
            'birthday-voucher-list' => '/admin/birthday-voucher',
            'push-voucher-by-parameter' => '/admin/push-voucher',
            'push-voucher-by-member-id' => '/admin/push-voucher',
            'merchant-list' => '/admin/merchants',
            'participating-merchant-list' => '/admin/participating-merchant',
            'fabs-list' => '/admin/fabs',
            'club-location-list' => '/admin/club-location',
            'cso-issuance-paid-list' => '/admin/cso-issuance-paid',
            'cso-issuance-free-list' => '/admin/cso-issuance-free',
            'cso-physical-list' => '/admin/cso-physical',
            'tier-list' => '/admin/tiers',
            'content-management' => '/admin/app-content',
            'dashboard-popup' => '/admin/dashboardpopup',
            'notification-list' => '/admin/notification',
            'cms-setting' => '/admin/cms-setting',
            'transaction-history' => '/admin/transaction-history',
            'voucher-logs' => '/admin/voucherlogs',
            'voucher-list' => '/admin/voucher-list',
            'evoucher-stock' => '/admin/evoucher-stock',
            't&d-reward-stock' => '/admin/treats-deals-stock',
        ];
